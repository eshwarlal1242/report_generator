...
import 'package:report_generator/screens/services/database_service.dart';
  ...
  Future<void> _generateAndSharePDF() async {
    ...
    pdf.addPage(pw.Page(
      build: (pw.Context context) {
        return pw.Column(
          children: [
            pw.Text('To-Do List', style: pw.TextStyle(fontSize: 24, fontWeight: pw.FontWeight.bold)),
            pw.SizedBox(height: 20),
            // List each task in the PDF
            ...tasks.map((task) {
              ...
              return pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    pw.Text('Title: ${task['title']}', style: pw.TextStyle(fontSize: 18, fontWeight: pw.FontWeight.bold)),
                    pw.Text('Description: ${task['description']}'),
                    pw.Text('Added on: $createdAt'),
